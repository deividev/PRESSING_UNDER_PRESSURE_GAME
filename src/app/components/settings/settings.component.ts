...
import { SettingsService, GameSettings, DifficultyLevel } from '../../services/settings.service';
...
export class SettingsComponent implements OnInit {
  ...
  difficultyOptions: { value: DifficultyLevel; label: string; description: string }[] = [];
  ...
  resetToDefaults(): void {
    const confirmMessage = this.translationService.translate('settings.resetConfirm') || 

...
export class TranslationService {
  ...
  private getTranslations(lang: Language): any {
    return lang === "en"
      ? this.getEnglishTranslations()
      : this.getSpanishTranslations();
  }
  ...
  private getEnglishTranslations(): any {
    return {
      ...
      victory: {
        ...
        VICTORY_MESSAGE: "Mission Complete! You survived all the rounds!",
      ...
      tutorial: {
        ...
        steps: {
          welcome: {
            title: "Welcome!",
            description:
              "Learn how to play Pressing Under Pressure in just a few steps.",
            example:
              "This is a high-stress reaction game that will test your speed and precision.",
          },
          objective: {
            title: "Objective",
            description:
              "Follow the on-screen instructions as quickly and accurately as possible.",
            example: "Each correct answer increases your score and streak!",
          },
          controls: {
            title: "Controls",
            description:
              'Use your keyboard to respond to challenges. You\'ll see instructions like "PRESS A" or "PRESS ANY KEY".',
            example:
              'Example: When you see "PRESS SPACE", press the spacebar quickly.',
          },
          time: {
            title: "Time Pressure",
            description:
              "Each challenge has a time limit. The faster you respond, the more points you earn.",
            example: "The timer bar at the top shows remaining time.",
          },
          streak: {
            title: "Combos",
            description:
              "Chain correct answers to build combos and multiply your score.",
            example:
              "3 correct = 2x score, 5 correct = 3x score, 10 correct = 5x score!",
          },
          difficulty: {
          ...
          lives: {
            title: "Mistakes",
            description:
              "You have limited attempts. Each error reduces your streak.",
  ...
  private getSpanishTranslations(): any {
    return {
      ...
      victory: {
        ...
        VICTORY_MESSAGE: "¡Misión Completa! ¡Sobreviviste a todas las rondas!",
      ...
      tutorial: {
        ...
        steps: {
          welcome: {
            title: "¡Bienvenido!",
            description:
              "Aprende a jugar Pressing Under Pressure en solo unos pasos.",
            example:
              "Este es un juego de reacción de alto estrés que pondrá a prueba tu velocidad y precisión.",
          },
          objective: {
            title: "Objetivo",
            description:
              "Sigue las instrucciones en pantalla lo más rápido y preciso posible.",
            example: "¡Cada respuesta correcta aumenta tu puntuación y racha!",
          },
          controls: {
            title: "Controles",
            description:
              'Usa tu teclado para responder a los desafíos. Verás instrucciones como "PRESIONA A" o "PRESIONA CUALQUIER TECLA".',
            example:
              'Ejemplo: Cuando veas "PRESIONA ESPACIO", presiona la barra espaciadora rápidamente.',
          },
          time: {
            title: "Presión de Tiempo",
            description:
              "Cada desafío tiene un límite de tiempo. Cuanto más rápido respondas, más puntos ganarás.",
            example:
              "La barra de tiempo en la parte superior muestra el tiempo restante.",
          },
          streak: {
            title: "Combos",
            description:
              "Encadena respuestas correctas para construir combos y multiplicar tu puntuación.",
            example:
              "3 correctas = 2x puntos, 5 correctas = 3x puntos, 10 correctas = 5x puntos!",
          },
          difficulty: {
            title: "Dificultad Progresiva",
            description:
              "Los desafíos se vuelven más difíciles a medida que avanzas. ¡Mantén la concentración!",
            example:
              "Los tiempos se acortan y los desafíos se vuelven más complejos.",
          },
          lives: {
            title: "Errores",
            description:
              "Tienes intentos limitados. Cada error reduce tu racha.",
            example: "Mantén la calma bajo presión para mantener tu combo.",
          },
          ready: {
            title: "¿Listo para Jugar?",
            description:
              "¡Ya sabes todo lo necesario para convertirte en un campeón!",
